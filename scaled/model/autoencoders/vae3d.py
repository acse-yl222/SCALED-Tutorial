...
from ..unets.unet_3ds_blocks import (
...
class Encoder(nn.Module):
    ...
    def forward(self, sample: torch.Tensor,control_feature=None) -> torch.Tensor:
        r"""The forward method of the `Encoder` class."""

        sample = self.conv_in(sample)
        if control_feature!=None:
            sample = sample+control_feature
